...
std::string ASimHUD::getSimModeFromUser()
{
    if (EAppReturnType::No == UAirBlueprintLib::ShowMessage(EAppMsgType::YesNo,
                                                            "Would you like to use single car simulation? Choose no to use quadrotor or both simulation.",
                                                            "Choose Vehicle")) {

      if (EAppReturnType::No == UAirBlueprintLib::ShowMessage(EAppMsgType::YesNo,
          "Would you like to simulate single quadrotor? Choose no to use both simulation.",
          "Choose Vehicle"))
      {
