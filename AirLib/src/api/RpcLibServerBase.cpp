    ...
    : api_provider_(api_provider)
{
    ...
    pimpl_->server.bind("simEnablePhysicsVehicle", [&](const std::string& vehicle_name) -> bool {
        return getVehicleSimApi(vehicle_name)->enablePhysics();
    });

    pimpl_->server.bind("simDisablePhysicsVehicle", [&](const std::string& vehicle_name) -> bool {
        return getVehicleSimApi(vehicle_name)->disablePhysics();
    });

    pimpl_->server.bind("simDisableCollisionsOfVehicleWithVehicle", [&](const std::string& vehicle_name, const std::string& colliding_vehicle_name) -> void{
        getVehicleSimApi(vehicle_name)->disableCollisionsWithVehicle(colliding_vehicle_name);
    });

    pimpl_->server.bind("simEnableCollisionsOfVehicleWithVehicle", [&](const std::string& vehicle_name, const std::string& colliding_vehicle_name) -> void{
        getVehicleSimApi(vehicle_name)->enableCollisionsWithVehicle(colliding_vehicle_name);
    });
